        ...
        <div class="d-flex flex-column justify-content-between h-100 hover-scroll-overlay-y my-2 d-flex flex-column" id="kt_app_sidebar_main" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_main" data-kt-scroll-offset="5px">
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="flex-column-fluid menu menu-sub-indention menu-column menu-rounded menu-active-bg mb-7">
                ...
                <?php if ($_GET['m'] != 'home') { ?>
                    ...
                    <!-- End Section -->
                    <div class="menu-item ">
                        <a class="menu-link <?= empty($_GET['m']) || $_GET['m'] == 'dashboard' && $_GET['s'] == 'index' || $_GET['s'] == 'create-income-master' || $_GET['s'] == 'create-income-detail' ? 'active' : '' ?>" href="index.php">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="#" style="margin-top: -10px;margin-bottom: -10px;">
                            ...
                            <span class="menu-title" style="color: #000;opacity:50%;text-transform: uppercase;font-size: 10px;">Administration</span>
                        </a>
                    </div>
                    <!-- End Section -->
                    <div class="menu-item">
                        <a class="menu-link <?= !empty($_GET['m']) && $_GET['m'] == 'settings' && $_GET['s'] == 'index' ? 'active' : '' ?>" href="index.php?m=settings&s=index">
                            <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
