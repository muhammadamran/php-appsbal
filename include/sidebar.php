            ...
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="flex-column-fluid menu menu-sub-indention menu-column menu-rounded menu-active-bg mb-7">
                <div class="menu-item">
                    <div class="menu-content pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Navigation Menu</span>
                    </div>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link <?= !empty($_GET['m']) && $_GET['m'] == 'bank' && $_GET['s'] == 'index' ? 'active' : '' ?>" href="index.php?m=bank&s=index">
                        <span class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link <?= !empty($_GET['m']) && $_GET['m'] == 'category' && $_GET['s'] == 'index' ? 'active' : '' ?>" href="index.php?m=category&s=index">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link <?= !empty($_GET['m']) && $_GET['m'] == 'account' && $_GET['s'] == 'index' ? 'active' : '' ?>" href="index.php?m=account&s=index">
                        <span class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <a class="menu-link <?= !empty($_GET['m']) && $_GET['m'] == 'clients' && $_GET['s'] == 'index' ? 'active' : '' ?>" href="index.php?m=clients&s=index">
                        <span class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
