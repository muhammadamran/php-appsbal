    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
            ...
            <a href="index.php" class="app-sidebar-logo" style="display: <?= $tlogo; ?>">
                <div style="display: flex;justify-content: flex-start;align-items: center;">
                    ...
                    <div style="margin-left: 1px;">
                        <h1 class="page-heading d-flex flex-column text-dark fw-bolder">M<font style="display: contents;color: #f6c000;">e</font>BEST<sup class="for-sup">Management Cash Flow</sup></h1>
                    </div>
                </div>
            </a>
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                ...
                <div class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    <span class="svg-icon svg-icon-muted svg-icon-2hx">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <path d="M19 15V18C19 18.6 18.6 19 18 19H6C5.4 19 5 18.6 5 18V15C6.1 15 7 14.1 7 13V10C7 7.6 8.7 5.6 11 5.1V3C11 2.4 11.4 2 12 2C12.6 2 13 2.4 13 3V5.1C15.3 5.6 17 7.6 17 10V13C17 14.1 17.9 15 19 15ZM11 10C11 9.4 11.4 9 12 9C12.6 9 13 8.6 13 8C13 7.4 12.6 7 12 7C10.3 7 9 8.3 9 10C9 10.6 9.4 11 10 11C10.6 11 11 10.6 11 10Z" fill="#d3d0d3" />
                        </svg>
                    </span>
                </div>
                ...
                <div class="cursor-pointer symbol symbol-30px symbol-lg-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <div class="avatar avatar-md">
                        <div class="header-profiles">
                            ...
                            ?>
                            <font class="page-heading d-flex flex-column text-dark fw-bolder" style="font-size: 15px;text-transform: uppercase;"><?= $showU; ?></font>
                        </div>
                    </div>
                </div>
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-6">
                <a href="index.php?m=settings&s=index" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
