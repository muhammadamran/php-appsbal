<title>Create Income Master - Dashboard | <?= $app_name; ?> &copy Official </title>
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                        ...
                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Create Income Master</li>
                    </ul>
                    <div style="display: flex;align-items: center;margin-top: -10px;margin-left: 0px;">
                        ...
                        <div style="margin-left: 5px;">
                            <h1 class="page-heading d-flex flex-column text-dark fw-bolder fs-1 lh-0">Create Income Master</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        <li class="nav-item mt-2">
                            <a class="nav-link ms-0 me-10 py-5 active" href="index.php?m=dashboard&s=create-income-master">Form Income Master</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <form action="pages/dashboard/action/action.php" class="form mb-15" method="POST">
                                        <div class="row mb-5">
                                            <div class="col-md-6 fv-row">
                                                <label class="required fs-5 fw-semibold mb-2">Income Name</label>
                                                <input type="text" class="form-control" name="income_name" placeholder="Income Name ..." required>
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <select name="income_year" data-control="select2" data-placeholder="Choose Year..." class="form-select">
                                                    <option value=""></option>
                                        ...
                                        <button type="submit" name="add_incoming_" class="btn btn-md btn-secondary">
                                            Save
                                        </button>
                                    </form>
                                </div>
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            <div class="mb-7">
                                                ...
                                                <div class="separator mb-5"></div>
                                                <p class="fw-semibold fs-6 text-gray-600">Please fill in the master income for 1 account with 1 bank in the current year.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
