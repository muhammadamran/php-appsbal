<div class="modal fade" id="kt_modal_create" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <form action="pages/bank/action/action.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="bank_name" placeholder="Bank Name ..." required>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" class="form-control form-control-solid" name="bank_code" placeholder="Bank Code ..." required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                                <span class="required">Call Center</span>
                                            </label>
                                            <input type="number" class="form-control form-control-solid" name="contact_label" placeholder="Call Center ..." required>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                                <span class="required">Bank Link</span>
                                            </label>
                                            <input type="text" class="form-control form-control-solid" name="bank_link" placeholder="Bank Link ..." required>
                                        </div>
                                    </div>
                                </div>
                            </div>
