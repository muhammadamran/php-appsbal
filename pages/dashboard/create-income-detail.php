...
if (isset($_POST["trn_detail"])) {
    $gid    = $_POST['income_id'];
    $gmonth = $_POST['income_month'];
    $gyear  = $_POST['income_year'];

    $query = $db->query("SELECT * FROM income WHERE income_id='$gid' AND income_year='$gyear' LIMIT 1");
    ...
    $gbankid = $rquery['bank_id'];
    $gbank   = $rquery['bank_name'];
}
if ($gmonth == '01') {
    $saymonth = 'January';
} else if ($gmonth == '02') {
...
?>
<title>Create Income Detail - <?= $gmonth ?> - <?= $saymonth ?> - Dashboard | <?= $app_name; ?> &copy Official </title>
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                        ...
                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Create Income Detail - <?= $gmonth ?> - <?= $saymonth ?></li>
                    </ul>
                        ...
                        <div style="display: flex;justify-content:space-between;align-items: center;">
                            <div>
                                <div class="dja">
                                    ...
                                    <div style="margin-left: 5px;">
                                        <h6 class="fw-bold m-0">Create Income Detail</h6>
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="d-flex flex-column flex-lg-row mb-0">
                                ...
                                <div class="flex-lg-row-fluid">
                                    ...
                                    <form action="pages/dashboard/action/action.php" class="form mb-15" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                        ...
                                                        <input type="hidden" class="form-control" name="bank_id" value="<?= $gbankid; ?>" readonly>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                        ...
                                                        <input type="text" class="form-control" name="transaction_name" placeholder="Transaction Name ..." required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                        ...
                                        <button type="submit" name="add_incoming_detail_" class="btn btn-md btn-secondary">
                                            Save
                                        </button>
                                    </form>
                                </div>
