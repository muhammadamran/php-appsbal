                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="">
                                    <thead style="background: #00906b;">
                                        <tr class="fs-7 text-white"
                                            style="font-size: 12px !important;font-weight:300 !important;;">
                                            <th>#</th>
                                        ...
                                        <tr class="fs-7 text-black"
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    title="Click to Input Amount on January <?= $fyear ?>">
                                                    ...
                                                    <form action="index.php?m=dashboard&s=create-income-detail"
                                                        method="POST" style="margin: 0;">
                                                        <input type="hidden" name="income_id"
                                                            value="<?= $row['income_id']; ?>">
                                                        <input type="hidden" name="income_month" value="01">
                                                        <input type="hidden" name="income_year"
                                                            value="<?= $row['income_year']; ?>">
                                                        <button style="border: 0;padding: 0;background: transparent;"
                                                            name="trn_detail" type="submit">
                                                            <?= $row['income_jan'] == NULL ? 'Rp. 0' : '' . Rupiah($row['income_jan'], TRUE); ?>
                                                        </button>
                                                    </form>
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=01&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on February <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=02&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on March <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=03&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on April <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=04&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on May <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=05&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on Juny <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=06&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on July <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=07&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on August <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=08&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on September <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=09&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on October <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=10&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on November <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=11&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to Input Amount on December <?= $fyear ?>">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-income-detail-edit&id=<?= $row['income_id']; ?>&month=12&year=<?= $row['income_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                ...
                <div class="row" style="padding: 15px;">
                    <div class="col-12">
                        <div style="display: flex;justify-content:space-between;align-items: center;">
                            ...
                            <div>
                                <a href="index.php?m=dashboard&s=create-expenses-master"
                                        ...
                                        <tr class="fs-7 text-black"
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <form action="index.php?m=dashboard&s=create-expenses-detail"
                                                        method="POST" style="margin: 0;">
                                                        <input type="hidden" name="expenses_id"
                                                            value="<?= $row['expenses_id']; ?>">
                                                        <input type="hidden" name="expenses_name"
                                                            value="<?= $row['expenses_name']; ?>">
                                                        <input type="hidden" name="expenses_month" value="01">
                                                        <input type="hidden" name="expenses_year"
                                                            value="<?= $row['expenses_year']; ?>">
                                                        <button style="border: 0;padding: 0;background: transparent;"
                                                            name="trn_detail" type="submit">
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=01&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=02&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=03&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=04&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=05&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=06&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=07&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=08&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=09&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=10&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=11&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
                                            ...
                                            <td>
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php } else { ?>
                                                    <a href="index.php?m=dashboard&s=create-expenses-detail-edit&id=<?= $row['expenses_id']; ?>&month=12&year=<?= $row['expenses_year'] ?>&usr=<?= $row['account_name'] ?>&bank=<?= $row['bank_name'] ?>"
                                                        style="color: #000;">
